...
import supabase from "../src/services/supabase.js";
 const supabaseUrl = 'https://fslvzslmpmavpanfriyi.supabase.co'
...
export default async function handler(req, res) {
  console.log("🔄 Serverless refresh triggered");

    await deleteBookings();
    await createBookings();

  res.status(200).json({ message: "Bookings refreshed successfully" });
}
